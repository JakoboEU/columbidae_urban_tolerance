...
```{r}
ggplot(paired_presence_shared_traits[paired_presence_shared_traits$Primary.Lifestyle == 'Terrestrial',], aes(x = cooccur, y = mntd)) + geom_boxplot()
```
```{r}
ggplot(paired_presence_shared_traits[paired_presence_shared_traits$Trophic.Niche == 'Frugivore',], aes(x = cooccur, y = mntd)) + geom_boxplot()
```
