...
```{r}
table(paired_presence_shared_traits$cooccur, paired_presence_shared_traits$genetically_close)
chisq.generically_close = chisq.test(table(paired_presence_shared_traits$cooccur, paired_presence_shared_traits$genetically_close))
summary(chisq.generically_close)
corrplot(chisq.generically_close$residuals, is.cor = FALSE)
```
