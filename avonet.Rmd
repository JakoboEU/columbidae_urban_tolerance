...
ggplot(community_change_df_l, aes(x = type, y = value)) + geom_line(aes(group = id), size = 0.1) +  geom_boxplot() + xlab('Community') + ylab('MNTD') + labs(title = "MNTD Change between Urban and Regional Communities", subtitle = "Wilcoxon signed rank (V = 27046, p-value < 2.2e-16)")
```
