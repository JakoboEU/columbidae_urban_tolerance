...
```{r}
species_pool_genetically_close_cooccurance$held_ratio = species_pool_cooccurance$held / species_pool_cooccurance$total_cities_paired
...
paired_presence_with_traits = left_join(paired_presence_with_traits_pt1, avonet_jetz, suffix = c('', '.Alternative'), by = c('alternative_species' = 'jetz_scientific_name'))

paired_presence_shared_traits = paired_presence_with_traits[
