...
library(grid)
library(gridExtra)
grid.arrange(gg_mntd_by_abs_latitude, gg_mntd_world, gg_mntd_change,
...
ggplot(frugivore_paired_to_city_data, aes(x = cooccur)) +
  ...
  xlab('Species pair co-occur') + ylab('Total open forest cover km2') + labs(title='Frugivore/Insessorial co-occurance vs total open forest cover', subtitle = 'chi-squared = 55.352, df = 1, p-value < 0.001')
```
...
ggplot(forest_paired_to_city_data, aes(x = cooccur)) +
  ...
  xlab('Species pair co-occur') + ylab('PC1 - Closed Forest / Average Rainfall') + labs(title='Forest Dwellers vs city landscape PC1 (99.7%)', subtitle = 'chi-squared = 62.286, df = 1, p-value < 0.001')
```
...
ggplot(forest_paired_to_city_data, aes(x = cooccur)) +
  ...
  xlab('Species pair co-occur') + ylab('PC2 - Open Forest / Min rainfall / City Area') + labs(title='Forest Dwellers vs city landscape PC2 (0.001%)', subtitle = 'chi-squared = 59.437, df = 1, p-value < 0.001')
```
