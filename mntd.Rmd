...
names(frugivore_interp[,frugivore_interp$varselect.interp])
```
...
names(insessorial_interp[,insessorial_interp$varselect.interp])
```
...
names(forest_interp[,forest_interp$varselect.interp])
```
